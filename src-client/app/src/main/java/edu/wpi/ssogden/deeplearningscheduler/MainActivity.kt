...
class MainActivity : AppCompatActivity() {
  ...
  private fun initService() {
    ...
    i.setClassName("edu.wpi.ssogden.deeplearningscheduler", "edu.wpi.ssogden.inferenceservice.InferenceService")

    //val i = Intent(this@MainActivity, InferenceService::class.java)
